...
# Model and format contrasts on 1.0 micromolar subset vs DMSO with limma
...
# Save limma matrices
write.csv2(logFC_matrix1, 'Cluster_LFC_1uM_250305a.csv')
write.csv2(logFC_matrix2, 'Cluster_LFCxPval_1uM_250305a.csv')
write.csv2(logFC_matrix3, 'Cluster_LFCxadjPval_1uM_250305a.csv')
...
# Write to csv
write.csv2(result_table1, 'Cluster1_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table2, 'Cluster2_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table3, 'Cluster3_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table4, 'Cluster4_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table5, 'Cluster5_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table6, 'Cluster6_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table7, 'Cluster7_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table8, 'Cluster8_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table9, 'Cluster9_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table10, 'Cluster10_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table11, 'Cluster11_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table12, 'Cluster12_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table13, 'Cluster13_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table14, 'Cluster14_1p0uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table15, 'Cluster15_1p0uM_Limma_250305a.csv', row.names = TRUE)
