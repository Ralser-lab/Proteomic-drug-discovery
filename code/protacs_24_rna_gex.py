...
"""
Script Name: protacs_24_rna_gex.py
Description:
...
Outputs
-------
- figures/protacs_24_rna_<CELL>_<TIMEPOINT>_<HALLMARK_ID>.pdf
...
from protacs_23_rna_gsea import PlotterCfg, list_getter
...
if __name__ == '__main__':
    ...
    cfg = replace(cfg, fig_path_suffix="figures/protacs_24_rna_")
