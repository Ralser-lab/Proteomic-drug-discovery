...
#'
#' Script Name: protacs_05_limma_cluster_10_250305a.R
#' Description: Differential expression analysis of PROTAC dataset (10 µM) 
...
#'           pheatmap, grid, cowplot# Define required CRAN and Bioconductor packages
#'
...
# Model and format contrasts on 10 micromolar subset vs DMSO with limma
...
# Save limma matrices
write.csv2(logFC_matrix1, 'Cluster_LFC_10uM_250305a.csv')
write.csv2(logFC_matrix2, 'Cluster_LFCxPval_10uM_250305a.csv')
write.csv2(logFC_matrix3, 'Cluster_LFCxadjPval_10uM_250305a.csv')
...
# Write to csv
write.csv2(result_table1, 'Cluster1_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table2, 'Cluster2_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table3, 'Cluster3_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table4, 'Cluster4_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table5, 'Cluster5_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table6, 'Cluster6_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table7, 'Cluster7_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table8, 'Cluster8_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table9, 'Cluster9_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table10, 'Cluster10_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table11, 'Cluster11_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table12, 'Cluster12_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table13, 'Cluster13_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table14, 'Cluster14_10uM_Limma_250305a.csv', row.names = TRUE)
write.csv2(result_table15, 'Cluster15_10uM_Limma_250305a.csv', row.names = TRUE)

# Plot volcano plot of select series (10 micromolar vs DMSO)
setwd(fig_dir)
library('cowplot')
png('protacs_05_volcanoes_10uM.png', width = 1200, height = 480)
