...
"""
Script Name: protacs_22_gbdt_train_narrow.py
Description:
    ...
    expandes on the hyperpameter search space used in protacs_16*.py.
...
round1.gbdt_optuna(params, X_train, y_train, score = 'balanced_accuracy', enqueue_params=seed_trial, n_trials=100)
...
round2.gbdt_optuna(params, X_train[top_features], y_train, score = 'balanced_accuracy', enqueue_params=seed_trial, n_trials=100)
