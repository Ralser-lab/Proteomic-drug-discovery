...
Inputs
------
- data/AZcompound_metadata_240611a.csv
...
# %% One hot encoding on drug labels
AZ_encoded = pd.get_dummies(AZ_cluster, prefix = '', prefix_sep= '')

# Perform euclidean clustering with ward linkage on one hot encoded labels
...
# %% Cut euclidian tree to generate 15 chemical series
...
# %% Remap series onto PC1 projection
remapping = {
    15:1, 8:2, 14:3, 10:4, 
    7:5, 13:6, 9:7, 6:8,
