...
if __name__ == '__main__':
    ...
    pasef_data = pd.read_csv(os.path.join(directory, 'SB_PROTAC_prmatrix_240314a.tsv'),
                         index_col = [0,1],
                         delimiter = '\t').T
    ...
    pasef_filter.save_output(pasef_filtered.T, 
                             os.path.join(output,'SB_PROTAC_prmatrix_filtered_95'))
    ...
    pasef_imputer.save_output(pasef_imputed.T, 
                               os.path.join(output,'SB_PROTAC_prmatrix_filtered_95_imputed_50'))
    ...
    pasef_batcher.save_output(pasef_batcher.input.T, 
                              os.path.join(output,'SB_PROTAC_prmatrix_filtered_95_imputed_50_ltrfm'))

    pasef_batcher.save_output(pasef_batcher.output.T, 
                              os.path.join(output, 'SB_PROTAC_prmatrix_filtered_95_imputed_50_ltrfm_batched'))
    ...
    path = pasef_summarizer.save_output(pasef_batched_long, 
                                        os.path.join(output,'SB_PROTAC_prmatrix_filtered_95_imputed_50_ltrfm_batched_long'))
