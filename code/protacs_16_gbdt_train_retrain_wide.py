...
"""
Script Name: protacs_16_gbdt_train_retrain_opt.py
Description:
    Train and evaluate Gradient Boosted Decision Tree (GBDT) models on 
    proteomic expression data and drug response (IC50) outcomes using Bayesian
    hyperparameter optimization (Optuna). The script performs a two-stage GBDT 
    workflow with model calibration. Outputs include trained models, feature 
...
------------
Python >= 3.8  
Dependencies: pandas, scikit-learn, joblib, optuna
